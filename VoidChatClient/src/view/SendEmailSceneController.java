...
public class SendEmailSceneController implements Initializable {
    ...
    void btnSendAction(ActionEvent event) {
        ...
        if(clientView.sendMail(to, body)){
            clientView.showSuccess("Exito", "Mensaje enviado", "correo enviado");
        }else{
            clientView.showError("Error", "No se ha enviado el correo", "a ocurrido un problema intenta despues");
        }
    }
